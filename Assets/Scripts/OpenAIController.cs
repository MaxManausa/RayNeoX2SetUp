...
public class OpenAIController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        api = new OpenAIAPI("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");
        StartConversation();
    ...
    private void StartConversation()
    {
        ...
        inputField.text = "";
        string startString = "I have been freed! Thank you, mortal. I offer you any mortal knowledge in regard to these topics:";
